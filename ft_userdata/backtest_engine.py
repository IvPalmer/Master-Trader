        ...
        if not _is_stage_available("robustness"):
            ...
            for strat_name in strat_names:
                ...
                try:
                    ...
                    trades = _viability_trades(via_data, strat_name)
