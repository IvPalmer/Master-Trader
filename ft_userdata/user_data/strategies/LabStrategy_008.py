...
class LabStrategy_008(IStrategy):
    """
    Auto-generated by Strategy Lab.
    Combo: bb(20,3)+vol(2.0)|btc_sma50+nc24|wide
    """
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['btc_gate'] = ((dataframe['btc_usdt_close_1h'] > dataframe['btc_usdt_sma50_1h']) & (dataframe['btc_usdt_close_1h'] >= dataframe['btc_usdt_close_1h'].shift(24) * 0.97)).astype(int)
        return dataframe
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        dataframe.loc[
            (
                ...
                (dataframe['volume'] > 2.0 * dataframe['vol_sma20']) &
