...
class LabStrategy_009(IStrategy):
    """
    Auto-generated by Strategy Lab.
    Combo: bb(20,3)+vol(2.0)|btc_sma50+rsi35|wide
    """
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['btc_gate'] = ((dataframe['btc_usdt_close_1h'] > dataframe['btc_usdt_sma50_1h']) & (dataframe['btc_usdt_rsi_1h'] > 35)).astype(int)
        return dataframe
